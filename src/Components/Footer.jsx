  ...
  return (
    <div>
      <div className="relative flex justify-start md:justify-center md:items-end ">
        <img className="absolute z-0 object-cover w-full h-full top-10 xl:mt-10" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/footer_5_marketing_background.png" alt="background" />
        <div className="relative z-10 flex flex-col items-start justify-start px-4 pt-36 md:pt-32 lg:pt-40 xl:pt-96 md:px-6 xl:px-20 md:justify-center md:items-center">
          <div className="flex flex-col items-start justify-start xl:justify-center xl:space-x-8 xl:flex-row">
            <div className="flex items-center justify-start space-x-4">
              <p className="text-3xl font-semibold leading-normal text-white w-60 xl:text-2xl"><span className='text-orange-400'>Int</span><span className='text-white'>elli</span><span className='text-green-400'>growth</span></p>
            </div>
            <div className="grid w-full grid-cols-1 mt-12 xl:mt-0 sm:grid-cols-3 gap-y-12 sm:gap-y-0 md:w-auto sm:gap-x-20 md:gap-x-28 xl:gap-8">
              <div className="flex flex-col items-start justify-start space-y-6 sm:w-40 md:w-auto xl:w-72">
                <h2 className="text-base font-bold leading-4 text-white xl:text-xl xl:font-semibold xl:leading-5">Community</h2>
              ...
              <div className="flex flex-col items-start justify-start space-y-6 sm:w-40 md:w-auto xl:w-72">
                <h2 className="text-base font-bold leading-4 text-white xl:text-xl xl:font-semibold xl:leading-5">Getting Started</h2>
                <button className="text-base leading-none text-left text-gray-100 hover:text-gray-400">
                  About Us
                </button>
                <button className="text-base leading-none text-left text-gray-100 hover:text-gray-400">
              ...
              <div className="flex flex-col items-start justify-start space-y-6 xl:w-72">
                <h2 className="text-base font-bold leading-4 text-white xl:text-xl xl:font-semibold xl:leading-5">Resources</h2>
                <button className="text-base leading-none text-left text-gray-100 hover:text-gray-400">
                  Accessibility
                </button>
                <button className="text-base leading-none text-left text-gray-100 hover:text-gray-400">
          ...
          <div className="flex flex-col-reverse items-center w-full mt-12 xl:justify-between xl:flex-row xl:items-start ">
            <p className="mt-10 text-sm leading-none text-white md:mt-12 xl:mt-0">2023 The IntelliGrowth Company. All Rights Reserved</p>
