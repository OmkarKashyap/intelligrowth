    ...
    <div className='flex flex-col gap-4 bg-black'>
        ...
        <div className='grid grid-cols-4 m-10'>
            <div className=''>
                ...
                <div className='text-white font-Poppins px-[40px] text-2xl font-semibold mb-4'>Personalized</div>
            ...
            <div className='w-6 mt-10 mb-4 ml-28 '>
                ...
                <div className='text-white font-Poppins px-[40px] text-2xl font-semibold mb-4'>Using LLMs</div>
                <div className='text-gray-500 px-[30px] text-sm font-Poppins mb-4'>Designed and developed with latest software and robust technologies using LLM</div>
                <div className='text-green-500 px-[30px] underline'>Read More {">"}</div>
            </div>
            <div>
            <div className='w-6 mt-10 mb-4 ml-28 '>
                ...
                <div className='text-white font-Poppins px-[40px] text-2xl font-semibold mb-4'>Suraksha First</div>
